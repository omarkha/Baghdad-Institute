    ...
    <div>
      <div className="employee-wrapper">
        <div className="container">
          <h1 className="mb-5">Academic Director</h1>
          <div className="employee">
            <h3>You You Will Be Doing</h3>
            <p className="mission">
              Working with faculty members to develop a high quality online
              Academy of Entrepreneurship. Must ensure quality education,
              fosting a positive learning environment, and empowering students
              to achieve their goals. The Academic Director has to be passionate
              about advancing the company's mission.
            </p>
